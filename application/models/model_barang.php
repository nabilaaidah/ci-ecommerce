<?php
   ...
   public function aksesoris(){
    return $this->db->where('kategori','Buku Fiksi')->from("tb_barang")->count_all_results();
   }
   public function sepatu_pria(){
      ...
      return $this->db->where('kategori','Buku Non Fiksi')->from("tb_barang")->count_all_results();
      
   }
   public function sepatu_wanita(){
    return $this->db->where('kategori','Komik')->from("tb_barang")->count_all_results();
   }
   public function sepatu_anak(){
    return $this->db->where('kategori','Buku Anak')->from("tb_barang")->count_all_results();
   }
   public function peralatan_olahraga(){
    return $this->db->where('kategori','Peralatan Tulis')->from("tb_barang")->count_all_results();
   }
