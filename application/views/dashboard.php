...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="<?php echo base_url('assets/img/slide-2.jpg'); ?>" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="<?php echo base_url('assets/img/slide-3.jpg'); ?>" class="d-block w-100" alt="...">
    </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <div class="row text-center mt-4">
        ...
        <div style="width: 100%; /* Ensure the image fills the width of the card */
                    height: 400px; /* Ensure the image fills the height of the card */
                    object-fit: cover; /* Resize the image while maintaining aspect ratio */
  ...
  <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; TOKO BUKU MEDIA 2023</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->